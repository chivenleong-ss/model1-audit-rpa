    ...
    def generate(self, df):
        ...
        try:
            ...
            for idx, row in df_calc.iterrows():
                ...
                # ========================================================
                # 【新增重磅】研发费用：影子冲销法则 (修正版：不抵消人工费，其余分类抵消)
                # ========================================================
                    ...
                    if '材料费' in gl_text_path:
                        sub_cat = '材料费'
                        offset_cat, offset_subcat = '(三)材料费', '研发支出-材料费'   # 👈 保留材料费的抵消
                    elif '人工成本' in gl_text_path:
                        sub_cat = '人工成本'
                        # 👇 删除了这里的 offset_cat 和 offset_subcat 赋值，取消人工费的同步抵消
                    elif '租赁及运行维护费' in gl_text_path:
                        sub_cat = '机械租赁'
                        offset_cat, offset_subcat = '(四)机械租赁费', '研发支出-机械租赁' # 👈 保留机械费的抵消
                    else:
